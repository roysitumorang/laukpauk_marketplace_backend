<ul class="nav nav-tabs">
	...
	<li role="presentation"{% if expand == 'villages' %} class="active"{% endif %}><a href="/admin/coupon_villages/index/coupon_id:{{ coupon.id }}">Berlaku Untuk Kelurahan</a></li>
	<li role="presentation"{% if expand == 'villages' %} class="active"{% endif %}><a href="/admin/coupon_usages/index/coupon_id:{{ coupon.id }}">Penggunaan</a></li>
</ul>
