...
<head>
	...
	<link rel="stylesheet" href="/backend/vendor/jquery-ui/jquery-ui.min.css">
	<link rel="stylesheet" href="/backend/vendor/jquery-ui/jquery-ui.theme.min.css">
	...
	<link rel="stylesheet" href="/backend/vendor/summernote/summernote-bs3.min.css">

	<!-- Head Libs -->
	<script src="/backend/vendor/modernizr/modernizr.min.js"></script>
</head>
<body>
