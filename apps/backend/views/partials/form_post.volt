	...
	<table class="table table-striped">
		<tr>
			<td>
				...
				<input type="text" name="subject" value="{{ post.subject }}" size="60" class="form form-control form-50">
			</td>
		</tr>
		<tr>
			<td>
	...
	<table id="extra-form" class="table table-striped" style="display:none">
		<tr>
			<td>
				...
				<input type="text" name="new_permalink" value="{{ post.new_permalink }}" size="60" class="form form-control form-50"><br>
		...
		<tr>
			<td>
				...
				<br>
				<input type="text" name="custom_link" value="{{ post.custom_link }}" size="70" class="form form-control form-60" placeholder="http://">
			</td>
		</tr>
		<tr>
			<td bgcolor="#e0ebeb">
				...
				<br>
				<input type="text" name="meta_title" value="{{ post.meta_title }}" size="70" class="form form-control form-50"><br>
		...
		<tr>
			<td bgcolor="#e0ebeb">
				...
				<br>
				<textarea name="meta_desc" cols="70" rows="3" class="form form-control form-50">{{ post.meta_desc }}</textarea><br>
		...
		<tr>
			<td bgcolor="#e0ebeb">
				...
				<br>
				<input type="text" name="meta_keyword" value="{{ post.meta_keyword }}" size="70" class="form form-control form-50">
			</td>
		</tr>
		<tr>
			<td bgcolor="#e0ebeb">
