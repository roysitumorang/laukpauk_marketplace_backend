				...
				<table class="table table-striped">
					...
					<tr>
						<td>
							...
							<br>
							<input type="text" name="name" value="{{ product.name }}" size="30" placeholder="Nama">
						</td>
					</tr>
					<tr>
						<td>
							...
							<br>
							<input type="text" name="stock_unit" value="{{ product.stock_unit }}" size="30" placeholder="Satuan produk">
						</td>
					</tr>
					<tr>
						<td>
							...
							<br>
							<input type="text" name="price" value="{{ product.price }}" size="10" maxlength="10" placeholder="Harga">
						</td>
					</tr>
					<tr>
						<td>
							...
							<br>
							<input type="text" name="stock" value="{{ product.stock }}" size="3" maxlength="3" placeholder="Harga">
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
							...
							<a href="javascript:void(0)" class="delete" data-user-id="{{ user.id }}" data-id="{{ product.id }}">
							...
							<script>
								...
								removal_link.onclick = () => {
									if (confirm('Anda yakin menghapus gambar ini ?')) {
										...
										form.method = 'POST',
										form.action = '/admin/users/' + removal_link.dataset.userId + '/products/' + removal_link.dataset.id + '/deletePicture?next={{ next }}',
					...
					<tr>
						<td>
							...
							<a type="button" href="{{ next }}" class="btn btn-warning">BATAL</a>
						</td>
					</tr>
				</table>
			</form>
