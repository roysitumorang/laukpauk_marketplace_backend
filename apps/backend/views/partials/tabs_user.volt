<ul class="nav nav-tabs">
	...
	<li{% if expand == 'products' %} class="active"{% endif %}><a {% if expand == 'products' %}href="#products" data-toggle="tab" aria-expanded="true"{% else %}href="/admin/store_items/index/user_id:{{ user.id }}"{% endif %}>Produk</a></li>
	{% endif %}
</ul>