<ul class="nav nav-tabs">
	...
	<li{% if expand == 'products' %} class="active"{% endif %}><a {% if expand == 'products' %}href="#products" data-toggle="tab" aria-expanded="true"{% else %}href="/admin/product_prices/index/user:id{{ user.id }}"{% endif %}>Produk</a></li>
	{% endif %}
</ul>