	...
	<div class="inner-wrapper">
		...
		<section role="main" class="content-body">
			<header class="page-header">
				<a href="/admin/users/{{ user.id }}/service_areas/create"><h2>Tambah Area Operasional</h2></a>
				<div class="right-wrapper pull-right">
					<ol class="breadcrumbs">
						...
						<li><span>Tambah Area Operasional</span></li>
					</ol>
			...
			<header class="panel-heading">
				<h2 class="panel-title">Tambah Area Operasional {{ user.name }}</h2>
			</header>
