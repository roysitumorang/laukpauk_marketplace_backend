	...
	<div class="inner-wrapper">
		...
		<section role="main" class="content-body">
			<header class="page-header">
				<a href="/admin/subdistricts/create/city_id:{{ city.id }}{% if page.current > 1 %}/page:{{ page.current }}{% endif %}"><h2>Tambah Kecamatan</h2></a>
				...
				<div class="tabs">
					...
					<div class="tab-content">
						<div id="cities" class="tab-pane active">
							{{ partial('partials/form_subdistrict', ['action': '/admin/subdistricts/create/city_id:' ~ city.id, 'pages': pages, 'page': page, 'city': city, 'subdistricts': subdistricts]) }}
						</div>
					</div>
				</div>
				<!-- eof Content //-->
