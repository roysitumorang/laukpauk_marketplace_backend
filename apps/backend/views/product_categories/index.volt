	...
	<div class="inner-wrapper">
		...
		<section role="main" class="content-body">
			<header class="page-header">
				<a href="/admin/product_categories"><h2>Daftar Kategori Produk</h2></a>
...
<script>
	let items = document.querySelectorAll('.published,.delete'), i = items.length, search = document.getElementById('search'), url = '/admin/product_categories/', replacement = {' ': '+', ':': '', '\/': ''};
	for ( ; i--; ) {
		let item = items[i];
		items[i].onclick = () => {
