	...
	<div class="inner-wrapper">
		...
		<section role="main" class="content-body">
			<header class="page-header">
				<a href="/admin/cities/create/province_id:{{ province.id }}{% if page.current > 1 %}/page:{{ page.current }}{% endif %}"><h2>Update Kabupaten / Kota</h2></a>
				...
				<div class="tabs">
					...
					<div class="tab-content">
						<div id="cities" class="tab-pane active">
							{{ partial('partials/form_city', ['action': '/admin/cities/update/' ~ city.id ~ '/province_id:' ~ province.id, 'pages': pages, 'page': page, 'province': province, 'cities': cities, 'types': types]) }}
						</div>
					</div>
				</div>
				<!-- eof Content //-->
