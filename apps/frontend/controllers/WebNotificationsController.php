	...
	function indexAction() {
		...
		$paginator    = new PaginatorModel([
			'data'  => $this->currentUser->getRelated('notifications', [
				'columns' => 'Application\Models\Notification.id, Application\Models\Notification.title, Application\Models\Notification.merchant_target_url, Application\Models\Notification.created_at, Application\Models\NotificationRecipient.read_at',
