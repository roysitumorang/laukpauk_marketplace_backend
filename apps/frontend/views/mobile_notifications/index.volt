	...
	<div class="inner-wrapper">
		...
		<section role="main" class="content-body">
			<header class="page-header">
				<a href="/mobile_notifications"><h2>Notifikasi Mobile</h2></a>
			...
			<div class="panel-body">
				<!-- Content //-->
				{{ flashSession.output() }}
				<a href="/mobile_notifications/create" title="Kirim Notifikasi"><i class="fa fa-paper-plane"></i> Kirim Notifikasi</a><br><br>
					...
					{% for notification in notifications %}
						<tr>
							...
							<td>
								...
								<strong>Link:</strong>&nbsp;{{ notification.merchant_target_url }}
							</td>
				...
				<div class="weepaging">
					<p>
						...
						{% for i in pages %}
							...
							<b>{{ i }}</b>
							{% else %}
							<a href="/mobile_notifications/index/page:{{ i }}">{{ i }}</a>
							{% endif %}
						{% endfor %}
					</p>
				</div>
