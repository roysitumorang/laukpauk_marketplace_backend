	...
	<div class="inner-wrapper">
		...
		<section role="main" class="content-body">
			<header class="page-header">
				<a href="/product_groups/{{ product_group.id }}/update"><h2>Edit Group Produk</h2></a>
				...
				<div class="tabs">
					...
					<div class="tab-content">
						<div id="group" class="tab-pane active">
							{{ partial('partials/form_product_group', ['action': '/product_groups/update/' ~ product_group.id, 'expand': group]) }}
						</div>
					</div>
				</div>
			</div>
