	...
	<div class="inner-wrapper">
		...
		<section role="main" class="content-body">
			<header class="page-header">
				<a href="/coupons"><h2>Kupon Member</h2></a>
			...
			<div class="panel-body">
				<!-- Content //-->
				{{ flashSession.output() }}
				<p style="margin-left:5px"><i class="fa fa-plus-square"></i>&nbsp;<a href="/coupons/create">Tambah Kupon</a></p>
				...
				<table class="table table-striped">
					...
					{% for coupon in coupons %}
						<tr>
							<td>{{ coupon.rank }}</td>
							<td>
								<font size="4" color="#006bb3"><strong><a href="/coupons/{{ coupon.id }}">{{ coupon.code }}</a></strong></font>&nbsp;
							...
							<td>
								<a href="/coupons/{{ coupon.id }}/update" title="Ubah"><i class="fa fa-pencil-square fa-2x"></i></a>
							</td>
						</tr>
					{% elsefor %}
						<tr>
				...
				<div class="weepaging">
					<p>
						...
						{% for i in pages %}
							...
							<b>{{ i }}</b>
							{% else %}
							<a href="/coupons{% if i > 1%}/index/page:{{ i }}{% endif %}">{{ i }}</a>
							{% endif %}
						{% endfor %}
					</p>
				</div>
