	...
	<div class="inner-wrapper">
		...
		<section role="main" class="content-body">
			<header class="page-header">
				<a href="/orders/{{ order.id }}"><h2>Detail Order #{{ order.code }}</h2></a>
				<div class="right-wrapper pull-right">
					<ol class="breadcrumbs">
						<li><a href="/"><i class="fa fa-home"></i></a></li>
						<li><span><a href="/orders">Order List</a></span></li>
						<li><span><a href="/orders{{ order.id }}">Detail Order #{{ order.code }}</a></span></li>
					</ol>
			...
			<header class="panel-heading">
				...
				<span style="float:right;margin-top:-20px">
					<a href="javascript:void(0)" onclick="let popup=window.open('/orders/{{ order.id }}/print','popup','height=800,width=800,resizeable=no,scrollbars=yes,toolbar=no,status=no');window.focus&&popup.focus()" title="Print Invoice"><i class="fa fa-print fa-2x"></i></a>
				</span>
				{% endif %}
			</header>
