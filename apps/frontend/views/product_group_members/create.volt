	...
	<div class="inner-wrapper">
		...
		<section role="main" class="content-body">
			<header class="page-header">
				<a href="/product_groups/create"><h2>Tambah Produk Ke Group</h2></a>
				...
				<div class="tabs">
					...
					<div class="tab-content">
						<div id="group" class="tab-pane active">
							{{ flashSession.output() }}
							<form method="GET" action="/product_group_members/create" id="search">
							...
							{% if products %}
								...
								<form method="POST" action="/product_group_members/create/product_group_id:{{ product_group.id }}{% if product_category_id %}/product_category_id:{{ product_category_id }}{% endif %}{% if keyword %}/keyword:{{ keyword }}{% endif %}{% if page.current > 1 %}/page:{{ page.current }}{% endif %}">
									<div class="row">
									...
									<a type="button" href="/product_group_members/index/product_group_id:{{ product_group.id }}" class="btn btn-default"><i class="fa fa-chevron-left"></i> Kembali</a>
							...
							<div class="weepaging">
								<p>
									...
									{% for i in pages %}
										...
										<b>{{ i }}</b>
										{% else %}
										<a href="/product_group_members/create/product_group_id:{{ product_group.id }}{% if product_category_id %}/product_category_id:{{ product_category_id }}{% endif %}{% if keyword %}/keyword:{{ keyword }}{% endif %}/page:{{ i }}">{{ i }}</a>
										{% endif %}
									{% endfor %}
								</p>
							</div>
